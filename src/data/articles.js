export const articles = [
    {
        ...
        description: "Aprenda como criar um sistema de paginação em react.js de forma rápida e pratica para que você possa usar em suas váriadas aplicações.",
    ...
    {
        title: "Tutorial: Criando login form em javascript",
        description: "Hoje vou lhe ensinar como criar um simples form utilizando HTML,Css e javascript.",
...

    {
        ...
        description: "A intenção deste artigo é te ensinar como manipular uma array de objetos em uma rota post feita em nodejs e mysql.",
    ...
    },
    {
        ...
        description: "A intensão deste artigo é te ensinar como criar de forma rápida e prática um servidor em Node.Js. É necessário que tenha instalado em sua máquina o gerenciador de pacotes NPM",
